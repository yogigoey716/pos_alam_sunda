...
import useMsPaymentMethods from "@/hooks/usePaymentMethods";

function MsPaymentMethodsPage() {
  ...
  const handleExport = () => {
    exportToExcel(paymentMethods, "payment-methods", "Payment Methods");
  };
  ...
  const { paymentMethods, total, pages, isLoading, error } = useMsPaymentMethods({
    ...filters,
    onUnauthorized,
  });
  ...
  return (
    <div className="w-full">
      {/* Header */}
      <div className="mb-8">
        <h1 className="mb-2 text-3xl font-bold tracking-tight">Master Metode Pembayaran</h1>
        <p className="text-base text-gray-500 dark:text-gray-400">
          Kelola semua metode pembayaran dalam sistem Anda
        </p>
      </div>
...
export default withAuth(MsPaymentMethodsPage);
