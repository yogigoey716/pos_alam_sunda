...
import { branchIngredientsService } from "@/services/api/branchIngredients";
import { useParams } from "next/navigation";

function EditBranchIngredientsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      await branchIngredientsService.updateMinimumStock(id, {
        min_stock,
      });
      router.push("/branch-ingredients");
    } catch (err) {
...
export default withAuth(EditBranchIngredientsPage);