...
function MsRolesPage() {
  ...
  const { role, total, pages, isLoading, error } = useRoles({
    ...filters,
    onUnauthorized,
  });
  ...
  return (
    <div className="w-full">
      {/* Header */}
      <div className="mb-8">
        <h1 className="mb-2 text-3xl font-bold tracking-tight">Master Role</h1>
        <p className="text-base text-gray-500 dark:text-gray-400">
          Kelola semua role dalam sistem Anda
        </p>
      </div>
...
export default withAuth(MsRolesPage);
