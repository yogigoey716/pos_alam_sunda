...
function SalesPage() {
    ...
    const { filters, filteredSales, updateFilter } = useSalesFilters(sales);
    ...
    const handleExportData = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "Data Report Sales");
        XLSX.writeFile(wb, "data-report-sales.xlsx");
    };
  ...
  return (
    <div className="overflow-x-auto relative shadow-md sm:rounded-lg">
        ...
        <div className="flex flex-wrap justify-between items-center pb-4">
          <div className="flex gap-2 items-center">
            ...
            <Selects
              ...
              id="sort"
              name="sort"
              value={filters.branch || "all"}                  // state branch sekarang
              onChange={(val) => updateFilter('branch', val)} // update state saat ganti cabang
            />
            <button
      ...
      <DataTablesReport data={datas} headers={headersReportSales} />
    </div>
  );
}
